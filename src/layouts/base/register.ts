...
layoutRegistry.register("two-col", TwoColLayout, { ...BASE_FEATURES, icon: "◌" });
layoutRegistry.register("stat-cards", StatCardsLayout, { ...BASE_FEATURES, icon: "◉" });
layoutRegistry.register("stat-cards-manifest", ManifestStatCardsLayout, { ...BASE_FEATURES, icon: "◉" });
layoutRegistry.register("before-after", BeforeAfterLayout, { ...BASE_FEATURES, icon: "⬡" });
layoutRegistry.register("h-strip", HStripLayout, { ...BASE_FEATURES, icon: "△" });
layoutRegistry.register("process-lanes", ProcessLanesLayout, { ...BASE_FEATURES, icon: "▤" });
